pub(super) fn shell_copy() -> super::ShellCopy {
    super::ShellCopy {
        app_name: "Agent Taskboard".into(),
                ...
                next_step: "下一步".into(),
                launch_title: "启动".into(),
                prefill_current: "沿用本 Project 上次配置，可修改。".into(),
                prefill_other: "沿用此 Agent 在其它 Project 的配置，可修改。".into(),
                prefill_seed: "沿用本机 CLI 默认值，可修改。".into(),
                isolation: "隔离执行目录".into(),
                isolation_off_reason: "不可用原因".into(),
                isolation_hint: "使用 git worktree；默认关闭，不记忆。".into(),
                ...
                opening_placeholder: "任务说明".into(),
                folded_options: "高级选项".into(),
                command_preview: "命令预览".into(),
                show_command_preview: "显示命令预览".into(),
                instruction_required: "请填写任务说明。".into(),
