pub(super) fn shell_copy() -> super::ShellCopy {
    super::ShellCopy {
                ...
                help_menu: "Help".into(),
                edit_undo: "Undo typing".into(),
                edit_redo: "Redo typing".into(),
                edit_cut: "Cut".into(),
                edit_copy: "Copy".into(),
                edit_paste: "Paste".into(),
                edit_select_all: "Select All".into(),
                usage_guide: "User guide".into(),
                ...
                run_persistence_recovery_title: "Run history needs recovery".into(),
                run_persistence_recovery_body: "The Host could not safely read runs.json. The original file was preserved, and actions that change Run history are paused.".into(),
                run_persistence_recovery_retry: "Retry Run history load".into(),
                run_persistence_write_failed: "The Host could not save a Run history change. The previous in-memory and on-disk history is still in use; retry the action.".into(),
                run_persistence_write_blocked: "Run history is in recovery. Repair runs.json and retry loading before changing Runs.".into(),
                new_run: "New".into(),
                ...
                prefill_current: "Using this Project's last config. You can edit it.".into(),
                prefill_other: "Using this Agent's config from another Project. You can edit it.".into(),
                prefill_seed: "Using the local CLI defaults. You can edit them.".into(),
                isolation: "Isolated work directory".into(),
                isolation_off_reason: "Why unavailable".into(),
                isolation_hint: "Uses a git worktree; off by default and not remembered.".into(),
                ...
                opening_placeholder: "Task description".into(),
                folded_options: "Advanced options".into(),
                command_preview: "Command preview".into(),
                show_command_preview: "Show command preview".into(),
                instruction_required: "Enter a task description.".into(),
