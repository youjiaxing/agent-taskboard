...
pub struct HostKernel {
    ...
    runs: Vec<RunSummary>,
    run_persistence_recovery: Option<RunPersistenceRecovery>,
    run_persistence_write_error: Option<RunPersistenceWriteError>,
...
impl HostKernel {
    ...
    fn boot_with_mode(
        ...
        let mut host = Self {
            ...
            sessions,
            runs: Vec::new(),
            run_persistence_recovery: None,
            run_persistence_write_error: None,
            live: BTreeMap::new(),
